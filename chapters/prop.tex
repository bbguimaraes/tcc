...
Nesse trabalho, ele será utilizado para gerar o melhor modelo possível para cada algoritmo, para que eles possam ser comparados igualmente. Em resumo, a etapa de execução consiste em:
