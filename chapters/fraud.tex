...
\iffalse[1] R. Barr, B. Golden, J. Kelly, M. Rescende, and W. Stewart. Designing and reporting on computational experiments with heuristic methods.  Journal of Heuristics, 1:9–32, 1995.\fi

Segundo \citeauthor{Barr}, um método pode ser avaliado em diversos aspectos: eficiência, eficácia, robustez, complexidade, impacto, potencial para generalização e inovação \cite{Barr}. \citeauthor{Brownlee2007} nota que isso é notável, já que muitos (ou a maioria) dos trabalhos foca apenas na qualidade da solução, que é apenas um aspecto da eficácia. Em seu trabalho, \citeauthor{Barr} apresentam os passos básicos para a experimentação como:
...
Além disso, sugerem diretrizes para o formato de divulgação:
