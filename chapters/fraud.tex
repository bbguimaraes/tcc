...
\begin{table}[h!]
    ...
    \begin{tabular}{c l c c}
        & & \multicolumn{2}{c}{\textbf{Dados reais}} \\
        \multirow{3}{5mm}{\begin{sideways}\parbox{20mm}{\textbf{Saída}}\end{sideways}} & \multicolumn{1}{c|}{} & Fraude & Legítimo & Total \\
        \cline{2-4}
        & \multicolumn{1}{c|}{Fraude}   & 300 & 200   & 500  \\
        & \multicolumn{1}{c|}{Legítimo} & 100 & 1000  & 1100 \\
        & \multicolumn{1}{c|}{Total}    & 400 & 1200  &      \\
    \end{tabular}
    \caption{Tabela de confusão}
    \label{fraud:confusion}
\end{table}
